" Vim color file
" -----------------------------
" harlequin.vim - a dark hi-contrast scheme, I just copied wombat256.vim
...
call <SID>X("Normal",		"00a0a0",	"202020",	"none")
...
call <SID>X("String",		"ffff00",	"",			"italic")
call <SID>X("Comment",		"a0a0a0",	"",			"italic")
call <SID>X("Identifier",	"80ffff",	"",			"none")
call <SID>X("Keyword",		"ffffff",	"",			"none")
call <SID>X("Statement",	"00ff80",	"",			"none")
call <SID>X("Function",		"ffff80",	"",			"none")
call <SID>X("PreProc",		"e5786d",	"",			"none")
call <SID>X("Type",			"caeb82",	"",			"none")
call <SID>X("Special",		"ff00ff",	"",			"none")
